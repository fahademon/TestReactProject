import { View, Text, StyleSheet, Image, TouchableOpacity, FlatList, Modal, TouchableWithoutFeedback, TextInput, ImageSourcePropType } from 'react-native';
...
const HotelReviews = () => {
                ...
                <TouchableWithoutFeedback
                    ...
                    <View style={[styles.modalContainer]}>
                        <View style={[styles.modalSubContainer, {
                            ...
                            />
                            <TextInput
                                placeholder="This hotel is so nice 🔥"
    ...
    */
    const renderContent = () => {
        ...
        const filteredReviews = selectedRating === "All" ? hotelReviews : hotelReviews.filter(review => review.avgRating === selectedRating);
        return (
            <ScrollView
